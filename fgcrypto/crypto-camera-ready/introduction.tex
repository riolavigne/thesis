...
Ball et al.~\cite{avgCaseFineGrained,eprintAvgCaseFG} began to address this issue through the lens of the recently blossoming field of {\em fine-grained complexity}.
